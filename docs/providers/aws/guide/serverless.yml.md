...
# Framework version constraint: '2', '>=2.33', '^2.33'
frameworkVersion: '2'
...
useDotenv: true
# Turn variable resolution errors in strict fatal errors by setting this value to "20210326" (default: null)
variablesResolutionMode: 20210326
# If set to 'error', references to variables that cannot be resolved will result in an error being thrown (applies to legacy resolver)
